...
export const studyStimuli: Stimulus[] = [
  {
    ...
    sculptureNameInternal: "Sitzende Figur",
    ...
    referenceImagePath: "/assets/sculptures/sculpture-01/reference.svg",
    rendererType: "splat",
    isPlaceholder: true,
  ...
  },
  {
    ...
    sculptureNameInternal: "Bogenform",
    hiddenVariantId: "variant-a",
    hiddenVariantLabel: "Hunyuan3D 2.1",
    assetType: "glb",
    assetPath: "/assets/sculptures/sculpture-02/variant-a/model.glb",
    referenceImagePath: "/assets/sculptures/sculpture-02/reference.svg",
    rendererType: "mesh",
    isPlaceholder: true,
